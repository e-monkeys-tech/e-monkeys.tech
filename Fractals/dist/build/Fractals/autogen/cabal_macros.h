...
/* package Fractals-1.0 */
#ifndef VERSION_Fractals
#define VERSION_Fractals "1.0"
#endif /* VERSION_Fractals */
#ifndef MIN_VERSION_Fractals
#define MIN_VERSION_Fractals(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_Fractals */
...
#define CURRENT_COMPONENT_ID "Fractals-1.0-AYIWrUh8e0GBQ82jGm0vZZ-Fractals"
